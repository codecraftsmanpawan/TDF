      ...
      if (userId) {
        try {
          const response = await axios.get(
            `http://13.61.104.53:5000/api/var/client/trades/chart/${userId}`
          );
...
//             const config = {
//                 method: 'get',
//                 url: `http://13.61.104.53:5000/api/var/client/${userId}`,
//                 headers: {
...
//             const config = {
//                 method: 'get',
//                 url: `http://13.61.104.53:5000/api/var/client/trades/mcx/${userId}`,
//                 headers: {
//                     'Authorization': `Bearer ${token}`
//                 }
//             };
